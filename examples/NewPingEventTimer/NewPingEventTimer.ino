// ---------------------------------------------------------------------------
// This example shows how to use UltraPing's ping_timer method which uses the Timer2 interrupt to get the
...
UltraPing sonar(TRIGGER_PIN, ECHO_PIN, MAX_DISTANCE); // UltraPing setup of pins and maximum distance.
